...
constructor() {
    ...
    // listener for show/hide transfer functions
    const checkbox = this.shadow.querySelector("input[name=showPreviewTransferFunction]");

    checkbox.addEventListener('change', function() {
        document.dispatchEvent(new CustomEvent('showPreviewTransferFunctions', { 'detail': this.checked }));
    });
}
